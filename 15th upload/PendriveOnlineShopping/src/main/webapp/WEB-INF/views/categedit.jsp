		...
		<form:form id="registerForm"  method="post"
			action="./updateCategory" commandName="categ">
			 ...
			 <tr>
                ...
                <td>
                    <form:input  type="text" path="catid" value="${catList.catid}"  readonly="true" class="form-control"/>
                </td>
           </tr>
           <tr>
                <td>
                ...
                <td>
                    <form:input  type="text" path="catname" value="${catList.catname}" class="form-control"/>
                </td>
          </tr>
          <tr>
          <td></td>
