...
app.controller('PendriveController', function($scope, $http) {
    $http.get("product")
...
<%--   <c:url var="userRegistration" value="saveUser.html" /> --%>
  <form:form id="registerForm" commandName="prod" method="post"
   ...
   <div ng-app="json" ng-controller="PendriveController">
   <table width="400px" height="150px">
   
    <tr>
     <td><label for="name">Product name</label>
     </td>
     <td><input data-ng-model="prod.name"/>
     </td>
    </tr>
    ...
    <tr>
     ...
     <td><input data-ng-model="prod.description"/>
     </td>
    </tr>
    ...
    <tr>
     ...
     <td><input data-ng-model="prod.price"/>
     </td>
    </tr>
  ...
  <a href="productlist">Click Here to see User List</a><br>
