...
<%@include file="header.jsp"%>
    <div class="container">
        ...
        We provide a good alternative to traditional e-shopping. Our home delivery ensures you save precious time, energy, fuel and save money as well.
Best of all, the more we grow, the more energy-efficient our service becomes.
          </form>
        </div>
    </div>
</div>
