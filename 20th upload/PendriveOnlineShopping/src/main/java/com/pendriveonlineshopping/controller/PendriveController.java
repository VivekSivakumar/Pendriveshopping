...
//        req.setAttribute("ïmages", src);
	...
	public String gotomemberDeails(@RequestParam(value="error",required = false) String error, @RequestParam(value="logout",required = false) String logout, Model model) 
	{
