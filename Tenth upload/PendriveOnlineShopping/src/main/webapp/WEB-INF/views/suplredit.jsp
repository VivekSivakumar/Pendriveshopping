		...
		<form:form id="registerForm"  method="post"
			...
			<table style="color: #1a75ff;" width="400px" height="150px">
			 <tr>
                ...
                <td>
                    <form:input type="text" path="spid" value="${spList.spid}"  readonly="true" class="form-control"/>
                </td>
           ...
           <tr>
                ...
                <td>
                    <form:input type="text" path="spname" value="${spList.spname}" class="form-control"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <form:input type="text" path="splace" value="${spList.splace}" class="form-control"/>
                </td>
                </tr>
                <tr>
           <td></td>
