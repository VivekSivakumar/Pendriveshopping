...
<tbody>
<tr>
<td><img src="<c:url value="${pd.product.img}"/>" height="70px" width="70px"></td>
...
<button class="btn btn-success"><a href="edu">Continue Shopping</a></button>
<button class="btn btn-success"><a href="payment">Payment</a></button>
